...
// update each of the widgets with the remote adapter
        for (int i = 0; i < appWidgetIds.length; ++i) {
            ...
            RemoteViews rv = new RemoteViews(context.getPackageName(), R.layout.widget_scores);
            ...
            rv.setEmptyView(R.id.score_list, R.id.widget_empty_view);
            ...
            rv.setPendingIntentTemplate(R.id.score_list, pendingIntent);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_DATA_UPDATED.equals(intent.getAction())) {
            ...
            appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetIds, R.id.score_list);
        }
    ...
    private void setRemoteAdapter(Context context, @NonNull final RemoteViews views) {
        views.setRemoteAdapter(R.id.score_list,
    ...
    private void setRemoteAdapterV11(Context context, @NonNull final RemoteViews views) {
        views.setRemoteAdapter(0, R.id.score_list,
                new Intent(context, DetailWidgetRemoteViewsService.class));
    }
}
